...
import { getOrCreateUserId } from "./local-storage"
...
/**
 * Signs in user with Google OAuth (disabled - app uses local storage only)
 */
export async function signInWithGoogle() {
  throw new Error("Authentication is disabled - app uses local storage only")
}

/**
 * Gets or creates a local guest user ID
 */
export const getOrCreateGuestUserId = async (
  ...
  // Use local storage to get or create user ID
